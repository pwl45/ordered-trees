\chapter{A Shfit Gray Code for Lukasiewicz Words}
...
\begin{subnumcases}{\luka{\alpha} = \label{eq:luka}} 
    \leftshift{n}{2} & if  $m=n$ \label{eq:prefix_n_2}\\
	\leftshift{m+1}{1} & if  $m=n-1$  or  $\alpha_{m} < \alpha_{m+2}$   or \label{eq:prefix_m1_1}\\
	    & $(\alpha_{m+2} = 0 $ and $ \sum \rho = m) $\nonumber\\
	\leftshift{m+2}{1} &  if $ \alpha_{m+2} \neq 0 $\label{eq:prefix_m2_1}\\
	\leftshift{m+2}{2} & otherwise  \label{eq:prefix_m2_2}
\end{subnumcases}
...
\LukaTable[2]{3,0,2,1,0,0} & 302100 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $100$ \\
\LukaTable[3]{2,3,0,1,0,0} & 230100 & 1 & \eqref{eq:prefix_m2_2} & $\leftshift{3}{2}$ & $100$ \\
\LukaTable[2]{2,0,3,1,0,0} & 203100 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $100$ \\
\LukaTable[3]{3,2,0,1,0,0} & 320100 & 3 & \eqref{eq:prefix_m2_2} & $\leftshift{5}{2}$ & $100$ \\
\LukaTable[2]{3,0,2,0,1,0} & 302010 & 2 & \eqref{eq:prefix_m2_2} & $\leftshift{4}{2}$ & $10$ \\
\LukaTable[2]{3,0,0,2,1,0} & 300210 & 3 & \eqref{eq:prefix_m1_1} & $\leftshift{4}{1}$ & $10$ \\
\LukaTable[3]{2,3,0,0,1,0} & 230010 & 1 & \eqref{eq:prefix_m2_2} & $\leftshift{3}{2}$ & $10$ \\
\LukaTable[2]{2,0,3,0,1,0} & 203010 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $10$ \\
\LukaTable[3]{3,2,0,0,1,0} & 320010 & 4 & \eqref{eq:prefix_m2_2} & $\leftshift{6}{2}$ & $10$ \\
\LukaTable[2]{3,0,2,0,0,1} & 302001 & 2 & \eqref{eq:prefix_m2_2} & $\leftshift{4}{2}$ & $1$ \\
\LukaTable[2]{3,0,0,2,0,1} & 300201 & 3 & \eqref{eq:prefix_m1_1} & $\leftshift{4}{1}$ & $1$ \\
\LukaTable[3]{2,3,0,0,0,1} & 230001 & 1 & \eqref{eq:prefix_m2_2} & $\leftshift{3}{2}$ & $1$ \\
\LukaTable[2]{2,0,3,0,0,1} & 203001 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $1$ \\
\LukaTable[3]{3,2,0,0,0,1} & 320001 & 5 & \eqref{eq:prefix_m1_1} & $\leftshift{6}{1}$ & $1$ \\
\LukaTable[3]{1,3,2,0,0,0} & 132000 & 1 & \eqref{eq:prefix_m1_1} & $\leftshift{2}{1}$ & $2000$ \\
\LukaTable[3]{3,1,2,0,0,0} & 312000 & 2 & \eqref{eq:prefix_m2_2} & $\leftshift{4}{2}$ & $2000$ \\
\LukaTable[2]{3,0,1,2,0,0} & 301200 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $200$ \\
\LukaTable[2]{1,3,0,2,0,0} & 130200 & 1 & \eqref{eq:prefix_m1_1} & $\leftshift{2}{1}$ & $200$ \\
\LukaTable[2]{3,1,0,2,0,0} & 310200 & 3 & \eqref{eq:prefix_m2_2} & $\leftshift{5}{2}$ & $200$ \\
\LukaTable[2]{3,0,1,0,2,0} & 301020 & 2 & \eqref{eq:prefix_m2_2} & $\leftshift{4}{2}$ & $20$ \\
\LukaTable[2]{3,0,0,1,2,0} & 300120 & 3 & \eqref{eq:prefix_m1_1} & $\leftshift{4}{1}$ & $20$ \\
\LukaTable[2]{1,3,0,0,2,0} & 130020 & 1 & \eqref{eq:prefix_m1_1} & $\leftshift{2}{1}$ & $20$ \\
\LukaTable[2]{3,1,0,0,2,0} & 310020 & 4 & \eqref{eq:prefix_m1_1} & $\leftshift{5}{1}$ & $20$ \\
\LukaTable[3]{2,3,1,0,0,0} & 231000 & 1 & \eqref{eq:prefix_m2_1} & $\leftshift{3}{1}$ & $31000$ \\
\LukaTable[3]{1,2,3,0,0,0} & 123000 & 1 & \eqref{eq:prefix_m1_1} & $\leftshift{2}{1}$ & $3000$ \\
\LukaTable[3]{2,1,3,0,0,0} & 213000 & 2 & \eqref{eq:prefix_m2_2} & $\leftshift{4}{2}$ & $3000$ \\
\LukaTable[2]{2,0,1,3,0,0} & 201300 & 2 & \eqref{eq:prefix_m1_1} & $\leftshift{3}{1}$ & $300$ \\
\LukaTable[2]{1,2,0,3,0,0} & 120300 & 1 & \eqref{eq:prefix_m1_1} & $\leftshift{2}{1}$ & $300$ \\
\LukaTable[2]{2,1,0,3,0,0} & 210300 & 3 & \eqref{eq:prefix_m1_1} & $\leftshift{4}{1}$ & $300$ \\
\LukaTable[3]{3,2,1,0,0,0} & 321000 & 6 & \eqref{eq:prefix_n_2} & $\leftshift{6}{2}$ & $\epsilon$ 
    \end{tabularx}
