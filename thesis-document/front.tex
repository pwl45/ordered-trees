...
\newcommand{\octosliceA}{%
  \draw[draw,fill=green](A) -- (B) -- (C) -- (D) -- (E) -- (A);
  \draw[draw, fill=red](F) -- (G) -- (H) -- (A);
  \draw[draw,fill=blue] (A) -- (E) -- (F) -- (A);
}

\newcommand{\octosliceB}{%
  \draw[draw,fill=green](B) -- (C) -- (D) -- (E) -- (B);
  \draw[draw, fill=red](F) -- (G) -- (H) -- (A) -- (B);
  \draw[draw,fill=blue] (B) -- (E) -- (F) -- (B);
}
\newcommand{\octosliceC}{%
  \draw[draw,fill=green](C) -- (D) -- (E) -- (C);
  \draw[draw, fill=red](F) -- (G) -- (H) -- (A) -- (B) -- (C);
  \draw[draw,fill=blue] (C) -- (E) -- (F) -- (C);
}
\newcommand{\octosliceD}{%
  \draw[draw,thick,fill=green](D) -- (E) -- (D);
  \draw[draw, fill=red](F) -- (G) -- (H) -- (A) -- (B) -- (C) -- (D);
  \draw[draw,fill=blue] (D) -- (E) -- (F) -- (D);
}

\newcommand{\octosliceG}{%
  \draw[draw,fill=green](A) -- (B) -- (C) -- (D) -- (E) -- (G) -- (F) -- (G) -- (H) -- (A);
  \draw[draw,fill=blue] (G) -- (E) -- (F) -- (G);
}

\newcommand{\octosliceH}{%
  \draw[draw,fill=green](H) -- (A) -- (B) -- (C) -- (D) -- (E) --(H) ;
  \draw[draw, fill=red](F) -- (G) -- (H) -- (A)-- (H);
  \draw[draw,fill=blue] (H) -- (E) -- (F) -- (H);
}
\newcommand{\octoslice}[1]{%
  \draw[draw,fill=red](A) -- (B) -- (C) -- (D) -- (E) -- ({#1}) -- (F) -- (G) -- (H) -- (A);
}
\newcommand{\octooslice}[1]{%
  \draw[draw,fill=red](1) -- (2) -- (3) -- (4) -- (5) -- ({#1}) -- (6) -- (7) -- (8) -- (1);
}
