...
For any $e \in \mathbf{E}_n$, traverse e in preorder.  Record a $1$ for each internal node; record a $0$ for each leaf. This process can be reversed to go from $\mathbf{D}_n$ to $\mathbf{E}_n$.
